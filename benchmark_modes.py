...
from src.heretic.config import Settings, DatasetMode
from src.heretic.model import Model, AbliterationParameters
from src.heretic.utils import load_prompts, empty_cache, format_duration
from src.heretic.evaluator import Evaluator
from src.heretic.activation_capture import capture_activations
from src.heretic.ridge_probe import precompute_ridge_terms, train_ridge_probes
from src.heretic.expansion import generate_self_play_dataset
...
def main():
    ...
    del good_residuals, bad_residuals, good_means, bad_means
    empty_cache()
