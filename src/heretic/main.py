...
from .config import ExportStrategy, QuantizationMethod, DatasetMode
...
def run():
    ...
    def objective(trial: Trial) -> tuple[float, ...]:
        ...
        model.reset_model()
        print("* Abliterating...")
        model.abliterate(residual_directions, direction_index, parameters, probes=probes)
        print("* Evaluating...")
